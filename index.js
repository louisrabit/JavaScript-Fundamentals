...
if (`${scoreDolphins} > ${scoreKoalas}`){
    console.log(`Dolphis finish with ${scoreDolphins} and Koalas with score of ${scoreKoalas} , the Winner is Dolphins`)
}else if ( `${scoreDolphins} < ${scoreKoalas}` ){
    console.log(`Dolphis finish with ${scoreDolphins} and Koalas with score of ${scoreKoalas} , the Winner is Koalas`)
}else if ( `${scoreDolphins} === ${scoreKoalas}`){
...
console.log(`Bill value is ${bill}, the tip ${tip} the final value is ${bill + tip}`)
